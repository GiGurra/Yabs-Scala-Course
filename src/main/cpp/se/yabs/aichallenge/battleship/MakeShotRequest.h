...
public:
	MakeShotRequest();
	virtual ~MakeShotRequest();

	/* custom_methods_begin *//* custom_methods_end */

	bool operator==(const MakeShotRequest& other) const;
	bool operator!=(const MakeShotRequest& other) const;
...
public:
	...
	MakeShotRequest& _setAllFieldsSet(const bool state, const mgen::FieldSetDepth depth);
	...
	MakeShotRequest * _deepCopy() const;
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 6955157086289771592LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = 14756;
