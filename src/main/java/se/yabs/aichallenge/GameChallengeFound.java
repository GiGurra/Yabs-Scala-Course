 ...
 ********************************************************************************************************************/	 		  
	...
	public static final long _TYPE_ID = 7479712952545752927L;

	public static final long[] _TYPE_IDS = { se.yabs.aichallenge.Message._TYPE_ID, se.yabs.aichallenge.GameChallengeFound._TYPE_ID };

	public static final short _TYPE_ID_16BIT = 24590;

	public static final short[] _TYPE_IDS_16BIT = { se.yabs.aichallenge.Message._TYPE_ID_16BIT, se.yabs.aichallenge.GameChallengeFound._TYPE_ID_16BIT };

	public static final String _TYPE_ID_16BIT_BASE64 = "YA4";

	public static final String[] _TYPE_IDS_16BIT_BASE64 = { se.yabs.aichallenge.Message._TYPE_ID_16BIT_BASE64, se.yabs.aichallenge.GameChallengeFound._TYPE_ID_16BIT_BASE64 };

	public static final String _TYPE_IDS_16BIT_BASE64_STRING = se.yabs.aichallenge.Message._TYPE_ID_16BIT_BASE64 + se.yabs.aichallenge.GameChallengeFound._TYPE_ID_16BIT_BASE64;

	public static final String _TYPE_NAME = "se.yabs.aichallenge.GameChallengeFound";

	public static final String[] _TYPE_NAMES = { se.yabs.aichallenge.Message._TYPE_NAME, se.yabs.aichallenge.GameChallengeFound._TYPE_NAME };

	public static final Field _game_METADATA = new Field("se.yabs.aichallenge.GameChallengeFound", "game", se.yabs.aichallenge.GameSelection._TYPE, null, (short)24849);
	public static final Field _opponent_METADATA = new Field("se.yabs.aichallenge.GameChallengeFound", "opponent", se.culvertsoft.mgen.api.model.StringType.INSTANCE, null, (short)17849);
