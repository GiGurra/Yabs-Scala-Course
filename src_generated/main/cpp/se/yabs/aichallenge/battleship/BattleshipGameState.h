...
#ifndef SE_YABS_AICHALLENGE_BATTLESHIP_BATTLESHIPGAMESTATE
#define SE_YABS_AICHALLENGE_BATTLESHIP_BATTLESHIPGAMESTATE
...
class BattleshipGameState : public mgen::MGenBase /* custom_ifcs_begin *//* custom_ifcs_end */ {
private:
	Player m_redPlayer;
	Player m_bluePlayer;
...
public:
	BattleshipGameState();
	BattleshipGameState(const Player& redPlayer,
	...
	BattleshipGameState& setRedPlayer(const Player& redPlayer);
	BattleshipGameState& setBluePlayer(const Player& bluePlayer);
	BattleshipGameState& setObservers(const std::vector<Player> & observers);
	BattleshipGameState& setRedMap(const Map& redMap);
	BattleshipGameState& setBlueMap(const Map& blueMap);
	BattleshipGameState& setPhase(const Phase& phase);
	BattleshipGameState& setCurrentTeam(const Team& currentTeam);
	...
	BattleshipGameState& unsetRedPlayer();
	BattleshipGameState& unsetBluePlayer();
	BattleshipGameState& unsetObservers();
	BattleshipGameState& unsetRedMap();
	BattleshipGameState& unsetBlueMap();
	BattleshipGameState& unsetPhase();
	BattleshipGameState& unsetCurrentTeam();

	bool operator==(const BattleshipGameState& other) const;
	bool operator!=(const BattleshipGameState& other) const;
...
public:
	...
	BattleshipGameState& _setRedPlayerSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setBluePlayerSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setObserversSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setRedMapSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setBlueMapSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setPhaseSet(const bool state, const mgen::FieldSetDepth depth);
	BattleshipGameState& _setCurrentTeamSet(const bool state, const mgen::FieldSetDepth depth);

	BattleshipGameState& _setAllFieldsSet(const bool state, const mgen::FieldSetDepth depth);
	...
	BattleshipGameState * _deepCopy() const;
 ...
 ********************************************************************************************************************/	 		  
	...
	static const long long _type_id = 3745151566608547621LL;
	static const std::vector<long long>& _type_ids();

	static const short _type_id_16bit = -2927;
	...
	static const short _field_redMap_id = 28692;
