...
public class ClassRegistry extends se.culvertsoft.mgen.javapack.classes.ClassRegistryBase  {
	...
	public static ClassRegistryEntry se_yabs_aichallenge_GameMessage = new ClassRegistryEntry(2246573734118294447L, se.yabs.aichallenge.GameMessage._TYPE_IDS, "se.yabs.aichallenge.GameMessage", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.GameMessage(); } });
	...
	public static ClassRegistryEntry se_yabs_aichallenge_GamePlayed = new ClassRegistryEntry(300559125798525147L, se.yabs.aichallenge.GamePlayed._TYPE_IDS, "se.yabs.aichallenge.GamePlayed", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.GamePlayed(); } });
	public static ClassRegistryEntry se_yabs_aichallenge_User = new ClassRegistryEntry(5020658785704657625L, se.yabs.aichallenge.User._TYPE_IDS, "se.yabs.aichallenge.User", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.User(); } });
	public static ClassRegistryEntry se_yabs_aichallenge_UserDb = new ClassRegistryEntry(263403507581591043L, se.yabs.aichallenge.UserDb._TYPE_IDS, "se.yabs.aichallenge.UserDb", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.UserDb(); } });
	...
	public static ClassRegistryEntry se_yabs_aichallenge_battleship_RequestFromServer = new ClassRegistryEntry(4376863526841852150L, se.yabs.aichallenge.battleship.RequestFromServer._TYPE_IDS, "se.yabs.aichallenge.battleship.RequestFromServer", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.battleship.RequestFromServer(); } });
	...
	public static ClassRegistryEntry se_yabs_aichallenge_battleship_ShotResult = new ClassRegistryEntry(1236274293076590984L, se.yabs.aichallenge.battleship.ShotResult._TYPE_IDS, "se.yabs.aichallenge.battleship.ShotResult", new Ctor() { public MGenBase create() { return new se.yabs.aichallenge.battleship.ShotResult(); } });
	...
	public ClassRegistry() {
		...
		add(se_yabs_aichallenge_GameMessage);
		...
		add(se_yabs_aichallenge_GamePlayed);
		add(se_yabs_aichallenge_User);
		add(se_yabs_aichallenge_UserDb);
		...
		add(se_yabs_aichallenge_battleship_RequestFromServer);
		...
		add(se_yabs_aichallenge_battleship_ShotResult);
	...
	public ClassRegistryEntry getByTypeIds16BitBase64(final String[] ids) {
		...
		switch((i < ids.length ? ids[i++] : "0xFFFFFFFF")) {
			case se.yabs.aichallenge.Message._TYPE_ID_16BIT_BASE64:
				switch((i < ids.length ? ids[i++] : "0xFFFFFFFF")) {
					case se.yabs.aichallenge.GameMessage._TYPE_ID_16BIT_BASE64:
						switch((i < ids.length ? ids[i++] : "0xFFFFFFFF")) {
							case se.yabs.aichallenge.battleship.BattleshipMessage._TYPE_ID_16BIT_BASE64:
								switch((i < ids.length ? ids[i++] : "0xFFFFFFFF")) {
									case se.yabs.aichallenge.battleship.RequestFromServer._TYPE_ID_16BIT_BASE64:
										switch((i < ids.length ? ids[i++] : "0xFFFFFFFF")) {
									...
									case se.yabs.aichallenge.battleship.MakeShot._TYPE_ID_16BIT_BASE64:
										return se_yabs_aichallenge_battleship_MakeShot;
									case se.yabs.aichallenge.battleship.ShotResult._TYPE_ID_16BIT_BASE64:
										return se_yabs_aichallenge_battleship_ShotResult;
			...
			case se.yabs.aichallenge.GamePlayed._TYPE_ID_16BIT_BASE64:
				return se_yabs_aichallenge_GamePlayed;
			case se.yabs.aichallenge.User._TYPE_ID_16BIT_BASE64:
				return se_yabs_aichallenge_User;
			case se.yabs.aichallenge.UserDb._TYPE_ID_16BIT_BASE64:
				return se_yabs_aichallenge_UserDb;
