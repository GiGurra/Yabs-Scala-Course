...
public:
	...
	GameState& setRedMap(const Map& redMap);
	GameState& setBlueMap(const Map& blueMap);
	...
	GameState& unsetRedMap();
	GameState& unsetBlueMap();
...
public:
	...
	GameState& _setRedMapSet(const bool state, const mgen::FieldSetDepth depth);
	GameState& _setBlueMapSet(const bool state, const mgen::FieldSetDepth depth);
